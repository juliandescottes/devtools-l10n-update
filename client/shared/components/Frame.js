...
class Frame extends Component {
  ...
  render() {
      ...
      if (functionDisplayName || showAnonymousFunctionName) {
        elements.push(
          dom.span(
            ...
            functionDisplayName ||
              webl10n.getString("stacktrace.anonymousFunction")
          ),
          " "
        );
      }
    ...
    if (messageSource && messageSource === MESSAGE_SOURCE.CSS) {
      tooltipMessage = l10n.getFormatString(
        "frame.viewsourceinstyleeditor",
        tooltip
      );
    } else {
      tooltipMessage = l10n.getFormatString("frame.viewsourceindebugger", tooltip);
    }
