    ...
    if (this.state.errorInfo !== null) {
      return div(
        ...
        h1(
          ...
          L10N.getFormatString("appErrorBoundary.description", this.props.panel)
        ),
        a(
          {
          ...
          L10N.getString("appErrorBoundary.fileBugButton")
        ),
        ...
        p(
          ...
          L10N.getString("appErrorBoundary.reloadPanelInfo")
        )
      );
    }
