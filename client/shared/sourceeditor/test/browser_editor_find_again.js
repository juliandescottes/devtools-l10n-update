...
const FIND_KEY = L10N.getString("find.key");
const FINDNEXT_KEY = L10N.getString("findNext.key");
const FINDPREV_KEY = L10N.getString("findPrev.key");
// the replace's key with the appropriate modifiers based on OS
const REPLACE_KEY =
  OS == "Darwin"
    ? L10N.getString("replaceAllMac.key")
    : L10N.getString("replaceAll.key");
