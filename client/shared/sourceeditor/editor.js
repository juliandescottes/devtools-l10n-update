...
Editor.prototype = {
  ...
  jumpToLine: function() {
    ...
    const txt = doc.createTextNode(L10N.getString("gotoLineCmd.promptTitle"));
...
Editor.keyFor = function(cmd, opts = { noaccel: false }) {
  const key = L10N.getString(cmd + ".commandkey");
