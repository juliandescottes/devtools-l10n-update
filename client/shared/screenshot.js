...
const screenshotDescription = L10N.getString("screenshotDesc");
const screenshotGroupOptions = L10N.getString("screenshotGroupOptions");
const screenshotCommandParams = [
  {
    name: "clipboard",
    type: "boolean",
    description: L10N.getString("screenshotClipboardDesc"),
    manual: L10N.getString("screenshotClipboardManual"),
  },
  {
    name: "delay",
    type: "number",
    description: L10N.getString("screenshotDelayDesc"),
    manual: L10N.getString("screenshotDelayManual"),
  },
  {
    name: "dpr",
    type: "number",
    description: L10N.getString("screenshotDPRDesc"),
    manual: L10N.getString("screenshotDPRManual"),
  },
  {
    name: "fullpage",
    type: "boolean",
    description: L10N.getString("screenshotFullPageDesc"),
    manual: L10N.getString("screenshotFullPageManual"),
  },
  {
    name: "selector",
    type: "string",
    description: L10N.getString("inspectNodeDesc"),
    manual: L10N.getString("inspectNodeManual"),
  },
  {
    name: "file",
    type: "boolean",
    description: L10N.getString("screenshotFileDesc"),
    manual: L10N.getString("screenshotFileManual"),
  },
  {
    name: "filename",
    type: "string",
    description: L10N.getString("screenshotFilenameDesc"),
    manual: L10N.getString("screenshotFilenameManual"),
  },
];
...
function saveToClipboard(base64URI) {
  try {
    ...
    return { text: L10N.getString("screenshotCopied") };
  } catch (ex) {
    console.error(ex);
    return { level: "error", text: L10N.getString("screenshotErrorCopying") };
  }
}
...
async function saveToFile(image) {
  ...
  try {
    ...
    return { text: L10N.getFormatString("screenshotSavedToFile", filename) };
  } catch (ex) {
    console.error(ex);
    return {
      level: "error",
      text: L10N.getFormatString("screenshotErrorSavingToFile", filename),
    };
  }
}
