...
function loadingPieChartData() {
  return [{ size: 1, label: L10N.getString("pieChart.loading") }];
}

function emptyPieChartData() {
  return [{ size: 1, label: L10N.getString("pieChart.unavailable") }];
}

function loadingTableChartData() {
  return [{ size: "", label: L10N.getString("tableChart.loading") }];
}

function emptyTableChartData() {
  return [{ size: "", label: L10N.getString("tableChart.unavailable") }];
}
