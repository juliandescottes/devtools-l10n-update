...
EventTooltip.prototype = {
  init: function() {
    ...
    const Bubbling = L10N.getString("eventsTooltip.Bubbling");
    const Capturing = L10N.getString("eventsTooltip.Capturing");
    for (const listener of this._eventListenerInfos) {
      ...
      if (listener.hide.filename) {
        text = L10N.getString("eventsTooltip.unknownLocation");
        title = L10N.getString("eventsTooltip.unknownLocationExplanation");
      } else {
      ...
      if (!listener.hide.debugger) {
        ...
        const openInDebugger = L10N.getString("eventsTooltip.openInDebugger");
