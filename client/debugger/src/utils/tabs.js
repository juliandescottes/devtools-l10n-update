...
export function getTabMenuItems() {
  return {
    closeTab: {
      ...
      label: L10N.getString("sourceTabs.closeTab"),
      accesskey: L10N.getString("sourceTabs.closeTab.accesskey"),
      disabled: false,
    },
    closeOtherTabs: {
      id: "node-menu-close-other-tabs",
      label: L10N.getString("sourceTabs.closeOtherTabs"),
      accesskey: L10N.getString("sourceTabs.closeOtherTabs.accesskey"),
      disabled: false,
    },
    closeTabsToEnd: {
      id: "node-menu-close-tabs-to-end",
      label: L10N.getString("sourceTabs.closeTabsToEnd"),
      accesskey: L10N.getString("sourceTabs.closeTabsToEnd.accesskey"),
      disabled: false,
    },
    closeAllTabs: {
      id: "node-menu-close-all-tabs",
      label: L10N.getString("sourceTabs.closeAllTabs"),
      accesskey: L10N.getString("sourceTabs.closeAllTabs.accesskey"),
      disabled: false,
    },
    showSource: {
    ...
    toggleBlackBox: {
      ...
      label: L10N.getString("ignoreContextItem.ignore"),
      accesskey: L10N.getString("ignoreContextItem.ignore.accesskey"),
      disabled: false,
    },
    prettyPrint: {
      id: "node-menu-pretty-print",
      label: L10N.getString("sourceTabs.prettyPrint"),
      accesskey: L10N.getString("sourceTabs.prettyPrint.accesskey"),
      disabled: false,
    },
  };
}
