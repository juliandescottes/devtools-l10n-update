...
export function formatShortcutResults() {
  return [
    {
      value: L10N.getString("symbolSearch.search.functionsPlaceholder.title"),
      title: `@ ${L10N.getString("symbolSearch.search.functionsPlaceholder")}`,
      id: "@",
    },
    {
      value: L10N.getString("symbolSearch.search.variablesPlaceholder.title"),
      title: `# ${L10N.getString("symbolSearch.search.variablesPlaceholder")}`,
      id: "#",
    },
    {
      value: L10N.getString("gotoLineModal.title"),
      title: `: ${L10N.getString("gotoLineModal.placeholder")}`,
      id: ":",
    },
  ];
}
