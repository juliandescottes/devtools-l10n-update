...
class SecondaryPanes extends Component {
  ...
  renderBreakpointsToggle() {
    ...
    const inputProps = {
      ...
      "aria-label": breakpointsDisabled
        ? L10N.getString("breakpoints.enable")
        : L10N.getString("breakpoints.disable"),
  ...
  watchExpressionHeaderButtons() {
    ...
    if (expressions.length) {
      buttons.push(
        debugBtn(
          ...
          "refresh",
          "refresh",
          L10N.getString("watchExpressions.refreshButton")
        )
      );
    }
    ...
    buttons.push(
      debugBtn(
        ...
        "plus",
        "plus",
        L10N.getString("expressions.placeholder")
      )
    );
  ...
  xhrBreakpointsHeaderButtons() {
    ...
    buttons.push(
      debugBtn(
        ...
        "plus",
        "plus",
        L10N.getString("xhrBreakpoints.label")
      )
    );
  ...
  getScopeItem() {
    return {
      header: L10N.getString("scopes.header"),
    ...
    return [
      <div key="scopes-buttons">
        <label
          ...
          title={L10N.getString("scopes.mapping.label")}
          onClick={e => e.stopPropagation()}
        >
          <input
            type="checkbox"
          ...
          />
          {L10N.getString("scopes.map.label")}
        </label>
        <a
          className="mdn"
          target="_blank"
          href={mdnLink}
          onClick={e => e.stopPropagation()}
          title={L10N.getString("scopes.helpTooltip.label")}
        >
    ...
    return [
      <div key="events-buttons">
        <label
          ...
          title={L10N.getString("eventlisteners.log.label")}
          onClick={e => e.stopPropagation()}
        >
          <input
            type="checkbox"
          ...
          />
          {L10N.getString("eventlisteners.log")}
        </label>
      </div>,
    ];
  }
  ...
  getWatchItem() {
    return {
      header: L10N.getString("watchExpressions.header"),
  ...
  getXHRItem() {
    ...
    return {
      header: L10N.getString("xhrBreakpoints.header"),
  ...
  getCallStackItem() {
    return {
      header: L10N.getString("callStack.header"),
  ...
  getThreadsItem() {
    return {
      header: L10N.getString("threadsHeader"),
  ...
  getBreakpointsItem() {
    ...
    return {
      header: L10N.getString("breakpoints.header"),
  ...
  getEventListenersItem() {
    ...
    return {
      header: L10N.getString("eventListenersHeader1"),
  ...
  getDOMMutationsItem() {
    ...
    return {
      header: L10N.getString("domMutationHeader"),
