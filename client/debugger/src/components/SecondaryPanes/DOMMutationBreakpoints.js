...
const localizationTerms = {
  subtree: L10N.getString("domMutationTypes.subtree"),
  attribute: L10N.getString("domMutationTypes.attribute"),
  removal: L10N.getString("domMutationTypes.removal"),
};
...
class DOMMutationBreakpointsContents extends Component {
  ...
  renderEmpty() {
    ...
    const text = L10N.getFormatString(
      ...
      `<a>${L10N.getString("inspectorTool")}</a>`
    );
