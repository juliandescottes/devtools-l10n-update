  ...
  renderStepButtons() {
    ...
    return [
      ...
      debugBtn(
        ...
        "stepOver",
        className,
        L10N.getFormatString("stepOverTooltip", formatKey("stepOver")),
        isDisabled
      ),
      debugBtn(
        () => this.props.stepIn(),
        "stepIn",
        className,
        L10N.getFormatString("stepInTooltip", formatKey("stepIn")),
      ...
      debugBtn(
        ...
        "stepOut",
        className,
        L10N.getFormatString("stepOutTooltip", formatKey("stepOut")),
        isDisabled
      ),
    ];
  }
  ...
  renderPauseButton() {
    ...
    if (this.props.isPaused) {
      return debugBtn(
        ...
        "resume",
        "active",
        L10N.getFormatString("resumeButtonTooltip", formatKey("resume"))
      );
    }
    ...
    if (isWaitingOnBreak) {
      return debugBtn(
        ...
        "pause",
        "disabled",
        L10N.getString("pausePendingButtonTooltip"),
        true
      );
    }
    ...
    return debugBtn(
      ...
      "pause",
      "active",
      L10N.getFormatString("pauseButtonTooltip", formatKey("resume"))
    );
  }
  ...
  renderSkipPausingButton() {
    ...
    return (
      <button
        ...
        title={
          skipPausing
            ? L10N.getString("undoSkipPausingTooltip.label")
            : L10N.getString("skipPausingTooltip.label")
        }
  ...
  renderSettingsButton() {
    ...
    return (
      <MenuButton
        ...
        title={L10N.getString("settings.button.label")}
      >
    ...
    return (
      <MenuList id="debugger-settings-menu-list">
        <MenuItem
          ...
          label={L10N.getString("settings.disableJavaScript.label")}
          tooltip={L10N.getString("settings.disableJavaScript.tooltip")}
          onClick={() => {
        ...
        <MenuItem
          ...
          label={L10N.getString("inlinePreview.toggle.label")}
          tooltip={L10N.getString("inlinePreview.toggle.tooltip")}
          onClick={() =>
        ...
        <MenuItem
          ...
          label={L10N.getString("editorWrapping.toggle.label")}
          tooltip={L10N.getString("editorWrapping.toggle.tooltip")}
        ...
        <MenuItem
          ...
          label={L10N.getString("settings.toggleSourceMaps.label")}
          tooltip={L10N.getString("settings.toggleSourceMaps.tooltip")}
          onClick={() =>
