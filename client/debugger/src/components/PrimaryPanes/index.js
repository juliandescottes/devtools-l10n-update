...
class PrimaryPanes extends Component {
  ...
  renderOutlineTabs() {
    ...
    const sources = formatKeyShortcut(L10N.getString("sources.header"));
    const outline = formatKeyShortcut(L10N.getString("outline.header"));
    ...
    return (
      <div key="root" className="sources-clear-root-container">
        <button
          ...
          title={L10N.getString("removeDirectoryRoot.label")}
        >
