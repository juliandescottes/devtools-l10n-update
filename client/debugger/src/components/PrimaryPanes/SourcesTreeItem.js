...
class SourceTreeItem extends Component {
  ...
  onContextMenu = (event, item) => {
    const copySourceUri2Label = L10N.getString("copySourceUri2");
    const copySourceUri2Key = L10N.getString("copySourceUri2.accesskey");
    const setDirectoryRootLabel = L10N.getString("setDirectoryRoot.label");
    const setDirectoryRootKey = L10N.getString("setDirectoryRoot.accesskey");
    const removeDirectoryRootLabel = L10N.getString("removeDirectoryRoot.label");
  ...
  addBlackboxAllOption = (menuOptions, item) => {
    ...
    if (depth === 0 || (depth === 1 && projectRoot === "")) {
      blackBoxInsideMenuItemLabel = allInsideBlackBoxed
        ? L10N.getString("unignoreAllInGroup.label")
        : L10N.getString("ignoreAllInGroup.label");
      if (sourcesOuside.length > 0) {
        blackBoxOutsideMenuItemLabel = allOusideBlackBoxed
          ? L10N.getString("unignoreAllOutsideGroup.label")
          : L10N.getString("ignoreAllOutsideGroup.label");
      }
    } else {
      blackBoxInsideMenuItemLabel = allInsideBlackBoxed
        ? L10N.getString("unignoreAllInDir.label")
        : L10N.getString("ignoreAllInDir.label");
      if (sourcesOuside.length > 0) {
        blackBoxOutsideMenuItemLabel = allOusideBlackBoxed
          ? L10N.getString("unignoreAllOutsideDir.label")
          : L10N.getString("ignoreAllOutsideDir.label");
      }
    }
    ...
    if (sourcesOuside.length > 0) {
      menuOptions.push({
        ...
        label: L10N.getString("ignoreAll.label"),
        submenu: [
  ...
  addCollapseExpandAllOptions = (menuOptions, item) => {
    ...
    menuOptions.push({
      ...
      label: L10N.getString("collapseAll.label"),
      disabled: false,
    ...
    menuOptions.push({
      ...
      label: L10N.getString("expandAll.label"),
      disabled: false,
  ...
  render() {
    ...
    const suffix = hasMatchingGeneratedSource ? (
      <span className="suffix">{L10N.getString("sourceFooter.mappedSuffix")}</span>
    ) : null;
