...
class Editor extends PureComponent {
  ...
  componentDidMount() {
    ...
    shortcuts.on(L10N.getString("toggleBreakpoint.key"), this.onToggleBreakpoint);
    shortcuts.on(
      L10N.getString("toggleCondPanel.breakpoint.key"),
      this.onToggleConditionalPanel
    );
    shortcuts.on(
      L10N.getString("toggleCondPanel.logPoint.key"),
      this.onToggleConditionalPanel
    );
    shortcuts.on(
      L10N.getString("sourceTabs.closeTab.key"),
  ...
  componentWillUnmount() {
    ...
    const { shortcuts } = this.context;
    shortcuts.off(L10N.getString("sourceTabs.closeTab.key"));
    shortcuts.off(L10N.getString("toggleBreakpoint.key"));
    shortcuts.off(L10N.getString("toggleCondPanel.breakpoint.key"));
    shortcuts.off(L10N.getString("toggleCondPanel.logPoint.key"));
  }
