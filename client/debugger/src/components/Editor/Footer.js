...
class SourceFooter extends PureComponent {
  ...
  prettyPrintButton() {
    ...
    const tooltip = L10N.getString("sourceTabs.prettyPrint");
  ...
  blackBoxButton() {
    ...
    const tooltip = blackboxed
      ? L10N.getString("sourceFooter.unignore")
      : L10N.getString("sourceFooter.ignore");
  ...
  renderSourceSummary() {
    ...
    const tooltip = L10N.getFormatString(
      "sourceFooter.mappedSourceTooltip",
      filename
    );
    const title = L10N.getFormatString("sourceFooter.mappedSource", filename);
  ...
  renderCursorPosition() {
    ...
    const text = L10N.getFormatString(
      "sourceFooter.currentCursorPosition",
      line + 1,
      column + 1
    );
    const title = L10N.getFormatString(
