...
export const addBreakpointItem = (cx, location, breakpointActions) => ({
  ...
  label: L10N.getString("editor.addBreakpoint"),
  accesskey: L10N.getString("shortcuts.toggleBreakpoint.accesskey"),
  disabled: false,
  click: () => breakpointActions.addBreakpoint(cx, location),
  accelerator: formatKeyShortcut(L10N.getString("toggleBreakpoint.key")),
});

export const removeBreakpointItem = (cx, breakpoint, breakpointActions) => ({
  id: "node-menu-remove-breakpoint",
  label: L10N.getString("editor.removeBreakpoint"),
  accesskey: L10N.getString("shortcuts.toggleBreakpoint.accesskey"),
  disabled: false,
...
export const addConditionalBreakpointItem = (location, breakpointActions) => ({
  ...
  label: L10N.getString("editor.addConditionBreakpoint"),
  accelerator: formatKeyShortcut(L10N.getString("toggleCondPanel.breakpoint.key")),
  accesskey: L10N.getString("editor.addConditionBreakpoint.accesskey"),
  disabled: false,
...
export const editConditionalBreakpointItem = (location, breakpointActions) => ({
  ...
  label: L10N.getString("editor.editConditionBreakpoint"),
  accelerator: formatKeyShortcut(L10N.getString("toggleCondPanel.breakpoint.key")),
  accesskey: L10N.getString("editor.addConditionBreakpoint.accesskey"),
  disabled: false,
  click: () => breakpointActions.openConditionalPanel(location),
...
export const toggleDisabledBreakpointItem = (
  ...
  return {
    accesskey: L10N.getString("editor.disableBreakpoint.accesskey"),
    disabled: false,
    click: () => breakpointActions.toggleDisabledBreakpoint(cx, breakpoint),
    ...(breakpoint.disabled
      ? {
          id: "node-menu-enable-breakpoint",
          label: L10N.getString("editor.enableBreakpoint"),
        }
      : {
          id: "node-menu-disable-breakpoint",
          label: L10N.getString("editor.disableBreakpoint"),
        }),
  };
};
...
export const toggleDbgStatementItem = (
  ...
  if (breakpoint && breakpoint.options.condition === "false") {
    return {
      ...
      label: L10N.getString("breakpointMenuItem.enabledbg.label"),
      click: () =>
  ...
  return {
    ...
    label: L10N.getString("breakpointMenuItem.disabledbg.label"),
    click: () =>
      breakpointActions.setBreakpointOptions(cx, location, {
        condition: "false",
      }),
...
export const removeBreakpointsOnLineItem = (
  ...
  label: L10N.getString("breakpointMenuItem.removeAllAtLine.label"),
  accesskey: L10N.getString("breakpointMenuItem.removeAllAtLine.accesskey"),
  disabled: false,
  click: () =>
...
export const enableBreakpointsOnLineItem = (
  ...
  id: "node-menu-remove-breakpoints-on-line",
  label: L10N.getString("breakpointMenuItem.enableAllAtLine.label"),
  accesskey: L10N.getString("breakpointMenuItem.enableAllAtLine.accesskey"),
  disabled: false,
  click: () =>
...
export const disableBreakpointsOnLineItem = (
  ...
  id: "node-menu-remove-breakpoints-on-line",
  label: L10N.getString("breakpointMenuItem.disableAllAtLine.label"),
  accesskey: L10N.getString("breakpointMenuItem.disableAllAtLine.accesskey"),
  disabled: false,
  click: () =>
