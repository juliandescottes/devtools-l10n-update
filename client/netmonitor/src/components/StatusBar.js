...
const REQUESTS_COUNT_EMPTY = L10N.getString(
  "networkMenu.summary.requestsCountEmpty"
);
const TOOLTIP_PERF = L10N.getString("networkMenu.summary.tooltip.perf");
const TOOLTIP_REQUESTS_COUNT = L10N.getString(
  "networkMenu.summary.tooltip.requestsCount"
);
const TOOLTIP_TRANSFERRED = L10N.getString(
  "networkMenu.summary.tooltip.transferred"
);
const TOOLTIP_FINISH = L10N.getString("networkMenu.summary.tooltip.finish");
const TOOLTIP_DOM_CONTENT_LOADED = L10N.getString(
  "networkMenu.summary.tooltip.domContentLoaded"
);
const TOOLTIP_LOAD = L10N.getString("networkMenu.summary.tooltip.load");
  ...
  render() {
    ...
    const countText =
      count === 0
        ...
        : PluralForm.get(
            count,
            L10N.getString("networkMenu.summary.requestsCount2")
          ).replace("#1", count);
