...
const RESPONSE_IMG_NAME = L10N.getString("netmonitor.response.name");
const RESPONSE_IMG_DIMENSIONS = L10N.getString("netmonitor.response.dimensions");
const RESPONSE_IMG_MIMETYPE = L10N.getString("netmonitor.response.mime");
