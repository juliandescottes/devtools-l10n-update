...
const FONT_NAME = L10N.getString("netmonitor.response.name");
const FONT_MIME_TYPE = L10N.getString("netmonitor.response.mime");
const FONT_PREVIEW_FAILED = L10N.getString(
