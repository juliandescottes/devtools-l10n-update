...
const RELOAD_NOTICE_1 = L10N.getString("netmonitor.reloadNotice1");
const RELOAD_NOTICE_2 = L10N.getString("netmonitor.reloadNotice2");
const RELOAD_NOTICE_3 = L10N.getString("netmonitor.reloadNotice3");
const PERFORMANCE_NOTICE_1 = L10N.getString("netmonitor.perfNotice1");
const PERFORMANCE_NOTICE_2 = L10N.getString("netmonitor.perfNotice2");
const PERFORMANCE_NOTICE_3 = L10N.getString("netmonitor.perfNotice3");
const PERFORMANCE_LEARN_MORE = L10N.getString("charts.learnMore");
