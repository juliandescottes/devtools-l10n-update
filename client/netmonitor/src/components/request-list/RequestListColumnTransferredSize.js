...
const SIZE_CACHED = L10N.getString("networkMenu.sizeCached");
const SIZE_SERVICE_WORKER = L10N.getString("networkMenu.sizeServiceWorker");
const SIZE_UNAVAILABLE = L10N.getString("networkMenu.sizeUnavailable");
const SIZE_UNAVAILABLE_TITLE = L10N.getString("networkMenu.sizeUnavailable.title");
...
class RequestListColumnTransferredSize extends Component {
  ...
  render() {
    ...
    if (blockedReason && blockingExtension) {
      text = L10N.getFormatString("networkMenu.blockedby", blockingExtension);
      ...
      if (typeof blockedReason == "string" && blockedReason.startsWith("NS_")) {
        ...
        text =
          ...
          L10N.getString("networkMenu.blocked2");
      }
      ...
      if (isRacing && typeof isRacing == "boolean") {
        text = L10N.getFormatString("networkMenu.raced", text);
      }
