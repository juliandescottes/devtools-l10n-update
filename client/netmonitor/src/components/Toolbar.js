...
// Localization
const FILTER_KEY_SHORTCUT = L10N.getString(
  "netmonitor.toolbar.filterFreetext.key"
);
const SEARCH_KEY_SHORTCUT = L10N.getString("netmonitor.toolbar.search.key");
const SEARCH_PLACE_HOLDER = L10N.getString(
  "netmonitor.toolbar.filterFreetext.label"
);
const COPY_KEY_SHORTCUT = L10N.getString("netmonitor.toolbar.copy.key");
const TOOLBAR_CLEAR = L10N.getString("netmonitor.toolbar.clear");
const TOOLBAR_TOGGLE_RECORDING = L10N.getString(
  "netmonitor.toolbar.toggleRecording"
);
const TOOLBAR_SEARCH = L10N.getString("netmonitor.toolbar.search");
const TOOLBAR_BLOCKING = L10N.getString("netmonitor.toolbar.requestBlocking");
const LEARN_MORE_TITLE = L10N.getString(
...
const TOOLBAR_FILTER_LABELS = FILTER_TAGS.concat("all").reduce(
  (o, tag) =>
    Object.assign(o, {
      [tag]: L10N.getString(`netmonitor.toolbar.filter.${tag}`),
    }),
  {}
);
const DISABLE_CACHE_TOOLTIP = L10N.getString(
  "netmonitor.toolbar.disableCache.tooltip"
);
const DISABLE_CACHE_LABEL = L10N.getString(
    ...
    return MenuButton(
      {
        ...
        title: L10N.getString("netmonitor.settings.menuTooltip"),
      },
  ...
  renderSettingsMenuItems() {
    ...
    const menuItems = [
      MenuItem({
        ...
        label: L10N.getString("netmonitor.toolbar.enablePersistentLogs.label"),
        tooltip: L10N.getString("netmonitor.toolbar.enablePersistentLogs.tooltip"),
      ...
      MenuItem({
        ...
        label: L10N.getString("netmonitor.har.importHarDialogTitle"),
        tooltip: L10N.getString("netmonitor.settings.importHarTooltip"),
        accesskey: L10N.getString("netmonitor.context.importHar.accesskey"),
      ...
      MenuItem({
        ...
        tooltip: L10N.getString("netmonitor.settings.saveHarTooltip"),
      ...
      MenuItem({
        ...
        tooltip: L10N.getString("netmonitor.settings.copyHarTooltip"),
        disabled: !displayedRequests.length,
