...
const COLLAPSE_DETAILS_PANE = L10N.getString("collapseDetailsPane");
const ALL_TABS_MENU_BUTTON_TOOLTIP = L10N.getString("allTabsMenuButton.tooltip");
const CACHE_TITLE = L10N.getString("netmonitor.tab.cache");
const COOKIES_TITLE = L10N.getString("netmonitor.tab.cookies");
const HEADERS_TITLE = L10N.getString("netmonitor.tab.headers");
const REQUEST_TITLE = L10N.getString("netmonitor.tab.request");
const RESPONSE_TITLE = L10N.getString("netmonitor.tab.response");
const SECURITY_TITLE = L10N.getString("netmonitor.tab.security");
const STACK_TRACE_TITLE = L10N.getString("netmonitor.tab.stackTrace");
const TIMINGS_TITLE = L10N.getString("netmonitor.tab.timings");
