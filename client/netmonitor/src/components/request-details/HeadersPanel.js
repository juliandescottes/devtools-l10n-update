...
const RESEND = L10N.getString("netmonitor.context.resend.label");
const EDIT_AND_RESEND = L10N.getString("netmonitor.summary.editAndResend");
const RAW_HEADERS = L10N.getString("netmonitor.headers.raw");
const HEADERS_EMPTY_TEXT = L10N.getString("headersEmptyText");
const HEADERS_FILTER_TEXT = L10N.getString("headersFilterText");
const REQUEST_HEADERS = L10N.getString("requestHeaders");
const REQUEST_HEADERS_FROM_UPLOAD = L10N.getString("requestHeadersFromUpload");
const RESPONSE_HEADERS = L10N.getString("responseHeaders");
const HEADERS_STATUS = L10N.getString("netmonitor.headers.status");
const HEADERS_VERSION = L10N.getString("netmonitor.headers.version");
const HEADERS_TRANSFERRED = L10N.getString("netmonitor.toolbar.transferred");
const SUMMARY_STATUS_LEARN_MORE = L10N.getString("netmonitor.summary.learnMore");
const SUMMARY_ETP_LEARN_MORE = L10N.getString(
  "netmonitor.enhancedTrackingProtection.learnMore"
);
const HEADERS_REFERRER = L10N.getString("netmonitor.headers.referrerPolicy");
const HEADERS_CONTENT_BLOCKING = L10N.getString(
  "netmonitor.headers.contentBlocking"
);
const HEADERS_ETP = L10N.getString(
    ...
    if (isThirdPartyTrackingResource) {
      ...
      trackingProtectionDetails = this.renderSummary(
        ...
        div(
          ...
          L10N.getString("netmonitor.trackingResource.tooltip"),
        ...
        button(
          {
            ...
            title: L10N.getString("netmonitor.context.blockURL"),
            onClick: () => openRequestBlockingAndAddUrl(urlDetails.url),
          },
          L10N.getString("netmonitor.headers.toolbar.block")
        ),
        span({ className: "devtools-separator" }),
        button(
          {
