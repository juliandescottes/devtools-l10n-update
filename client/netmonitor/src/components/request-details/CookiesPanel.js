...
const COOKIES_EMPTY_TEXT = L10N.getString("cookiesEmptyText");
const COOKIES_FILTER_TEXT = L10N.getString("cookiesFilterText");
const REQUEST_COOKIES = L10N.getString("requestCookies");
const RESPONSE_COOKIES = L10N.getString("responseCookies");
