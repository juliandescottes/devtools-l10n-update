  ...
  renderServerTimings() {
    ...
    return div(
      ...
      div(
        ...
        L10N.getString("netmonitor.timings.serverTiming")
      ),
  ...
  render() {
    ...
    if (!eventTimings) {
      return div(
        ...
        L10N.getString("netmonitor.timings.noTimings")
      );
    }
    ...
    const timelines = TIMING_KEYS.map((type, idx) => {
      ...
      return div(
        ...
        span(
          { className: "tabpanel-summary-label timings-label" },
          L10N.getString(`netmonitor.timings.${type}`)
        ),
        div(
          { className: "requests-list-timings-container" },
          span({
    ...
    return div(
      ...
      div(
        { className: "label-separator" },
        L10N.getString("netmonitor.timings.requestTiming")
      ),
      timelines,
      this.renderServerTimings(),
      MDNLink({
        url: getNetMonitorTimingsURL(),
        title: L10N.getString("netmonitor.timings.learnMore"),
      })
    );
  }
}
