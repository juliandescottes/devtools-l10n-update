...
const CACHE = L10N.getString("netmonitor.cache.cache");
const DATA_SIZE = L10N.getString("netmonitor.cache.dataSize");
const EXPIRES = L10N.getString("netmonitor.cache.expires");
const FETCH_COUNT = L10N.getString("netmonitor.cache.fetchCount");
const LAST_FETCHED = L10N.getString("netmonitor.cache.lastFetched");
const LAST_MODIFIED = L10N.getString("netmonitor.cache.lastModified");
const DEVICE = L10N.getString("netmonitor.cache.device");
const NOT_AVAILABLE = L10N.getString("netmonitor.cache.notAvailable");
const EMPTY = L10N.getString("netmonitor.cache.empty");
