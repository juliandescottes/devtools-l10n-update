...
const REQUEST_EMPTY_TEXT = L10N.getString("paramsNoPayloadText");
const REQUEST_FILTER_TEXT = L10N.getString("paramsFilterText");
const REQUEST_FORM_DATA = L10N.getString("paramsFormData");
const REQUEST_POST_PAYLOAD = L10N.getString("paramsPostPayload");
const RAW_REQUEST_PAYLOAD = L10N.getString("netmonitor.request.raw");
const REQUEST_TRUNCATED = L10N.getString("requestTruncated");
