...
const { div, span } = dom;
const NOT_AVAILABLE = L10N.getString("netmonitor.security.notAvailable");
const ERROR_LABEL = L10N.getString("netmonitor.security.error");
const CIPHER_SUITE_LABEL = L10N.getString("netmonitor.security.cipherSuite");
const WARNING_CIPHER_LABEL = L10N.getString("netmonitor.security.warning.cipher");
const ENABLED_LABEL = L10N.getString("netmonitor.security.enabled");
const DISABLED_LABEL = L10N.getString("netmonitor.security.disabled");
const CONNECTION_LABEL = L10N.getString("netmonitor.security.connection");
const PROTOCOL_VERSION_LABEL = L10N.getString(
  "netmonitor.security.protocolVersion"
);
const KEA_GROUP_LABEL = L10N.getString("netmonitor.security.keaGroup");
const KEA_GROUP_NONE = L10N.getString("netmonitor.security.keaGroup.none");
const KEA_GROUP_CUSTOM = L10N.getString("netmonitor.security.keaGroup.custom");
const KEA_GROUP_UNKNOWN = L10N.getString("netmonitor.security.keaGroup.unknown");
const SIGNATURE_SCHEME_LABEL = L10N.getString(
  "netmonitor.security.signatureScheme"
);
const SIGNATURE_SCHEME_NONE = L10N.getString(
  "netmonitor.security.signatureScheme.none"
);
const SIGNATURE_SCHEME_UNKNOWN = L10N.getString(
  "netmonitor.security.signatureScheme.unknown"
);
const HSTS_LABEL = L10N.getString("netmonitor.security.hsts");
const HPKP_LABEL = L10N.getString("netmonitor.security.hpkp");
const CERTIFICATE_LABEL = L10N.getString("netmonitor.security.certificate");
const CERTIFICATE_TRANSPARENCY_LABEL = L10N.getString(
  "certmgr.certificateTransparency.label"
);
const CERTIFICATE_TRANSPARENCY_POLICY_COMPLIANT = L10N.getString(
  "certmgr.certificateTransparency.status.ok"
);
const CERTIFICATE_TRANSPARENCY_POLICY_NOT_ENOUGH_SCTS = L10N.getString(
  "certmgr.certificateTransparency.status.notEnoughSCTS"
);
const CERTIFICATE_TRANSPARENCY_POLICY_NOT_DIVERSE_SCTS = L10N.getString(
  "certmgr.certificateTransparency.status.notDiverseSCTS"
);
const SUBJECT_INFO_LABEL = L10N.getString("certmgr.subjectinfo.label");
const CERT_DETAIL_COMMON_NAME_LABEL = L10N.getString("certmgr.certdetail.cn");
const CERT_DETAIL_ORG_LABEL = L10N.getString("certmgr.certdetail.o");
const CERT_DETAIL_ORG_UNIT_LABEL = L10N.getString("certmgr.certdetail.ou");
const ISSUER_INFO_LABEL = L10N.getString("certmgr.issuerinfo.label");
const PERIOD_OF_VALIDITY_LABEL = L10N.getString("certmgr.periodofvalidity.label");
const BEGINS_LABEL = L10N.getString("certmgr.begins");
const EXPIRES_LABEL = L10N.getString("certmgr.expires");
const FINGERPRINTS_LABEL = L10N.getString("certmgr.fingerprints.label");
const SHA256_FINGERPRINT_LABEL = L10N.getString(
  "certmgr.certdetail.sha256fingerprint"
);
const SHA1_FINGERPRINT_LABEL = L10N.getString(
...
const getObject = ({ securityInfo, url }) => {
  ...
  const HOST_HEADER_LABEL = L10N.getFormatString(
