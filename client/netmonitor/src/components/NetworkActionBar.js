      ...
      Tabbar(
        {
          ...
          sidebarToggleButton: {
            collapsed: false,
            collapsePaneTitle: L10N.getString("collapseActionPane"),
            expandPaneTitle: "",
        ...
        showSearchPanel &&
          TabPanel(
            {
              id: PANELS.SEARCH,
              title: L10N.getString("netmonitor.actionbar.search"),
        ...
        showBlockingPanel &&
          TabPanel(
            {
              id: PANELS.BLOCKING,
              title: L10N.getString("netmonitor.actionbar.requestBlocking2"),
