...
const CUSTOM_CANCEL = L10N.getString("netmonitor.custom.cancel");
const CUSTOM_HEADERS = L10N.getString("netmonitor.custom.headers");
const CUSTOM_NEW_REQUEST = L10N.getString("netmonitor.custom.newRequest");
const CUSTOM_NEW_REQUEST_METHOD_LABEL = L10N.getString(
  "netmonitor.custom.newRequestMethodLabel"
);
const CUSTOM_NEW_REQUEST_URL_LABEL = L10N.getString(
  "netmonitor.custom.newRequestUrlLabel"
);
const CUSTOM_POSTDATA = L10N.getString("netmonitor.custom.postData");
const CUSTOM_QUERY = L10N.getString("netmonitor.custom.query");
const CUSTOM_SEND = L10N.getString("netmonitor.custom.send");
