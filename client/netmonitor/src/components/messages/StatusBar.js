...
const MESSAGE_COUNT_EMPTY = L10N.getString(
  "networkMenu.ws.summary.framesCountEmpty"
);
const TOOLTIP_MESSAGE_COUNT = L10N.getString(
  "networkMenu.ws.summary.tooltip.framesCount"
);
const TOOLTIP_MESSAGE_TOTAL_SIZE = L10N.getString(
  "networkMenu.ws.summary.tooltip.framesTotalSize"
);
const TOOLTIP_MESSAGE_TOTAL_TIME = L10N.getString(
  ...
  render() {
    ...
    const countText =
      count === 0
        ...
        : PluralForm.get(
            count,
            L10N.getString("networkMenu.ws.summary.framesCount2")
          ).replace("#1", count);
