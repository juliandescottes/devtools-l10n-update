...
// Localization
const MSG_TOOLBAR_CLEAR = L10N.getString("netmonitor.ws.toolbar.clear");
const MSG_SEARCH_KEY_SHORTCUT = L10N.getString(
  "netmonitor.ws.toolbar.filterFreetext.key"
);
const MSG_SEARCH_PLACE_HOLDER = L10N.getString(
