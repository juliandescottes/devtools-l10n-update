...
class MessageFilterMenu extends PureComponent {
    ...
    const menuItems = [
      {
        ...
        label: L10N.getString("netmonitor.ws.context.all"),
        accesskey: L10N.getString("netmonitor.ws.context.all.accesskey"),
        type: "checkbox",
      ...
      },
      {
        ...
        label: L10N.getString("netmonitor.ws.context.sent"),
        accesskey: L10N.getString("netmonitor.ws.context.sent.accesskey"),
        type: "checkbox",
      ...
      },
      {
        ...
        label: L10N.getString("netmonitor.ws.context.received"),
        accesskey: L10N.getString("netmonitor.ws.context.received.accesskey"),
        type: "checkbox",
      ...
      },
      {
        ...
        label: L10N.getString("netmonitor.ws.context.controlFrames"),
        accesskey: L10N.getString("netmonitor.ws.context.controlFrames.accesskey"),
        type: "checkbox",
  ...
  render() {
    ...
    const messageFilterTypeTitle = L10N.getString(
      `netmonitor.ws.context.${messageFilterType}`
    );
    const title =
      messageFilterTypeTitle +
      (showControlFrames
        ? " (" + L10N.getString(`netmonitor.ws.context.controlFrames`) + ")"
        : "");
