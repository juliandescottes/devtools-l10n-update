...
const MESSAGES_EMPTY_TEXT = L10N.getString("messagesEmptyText");
const TOGGLE_MESSAGES_TRUNCATION = L10N.getString("toggleMessagesTruncation");
const TOGGLE_MESSAGES_TRUNCATION_TITLE = L10N.getString(
  "toggleMessagesTruncation.title"
);
const CONNECTION_CLOSED_TEXT = L10N.getString("netmonitor.ws.connection.closed");
const {
  MESSAGE_HEADERS,
  ...
  render() {
    ...
    if (shouldTruncate) {
      ...
      MESSAGES_TRUNCATED = PluralForm.get(
        this.currentTruncatedNum,
        L10N.getString("netmonitor.ws.truncated-messages.warning")
