...
class Toolbar extends Component {
  ...
  renderClearButton() {
    return button({
      ...
      title: L10N.getString("netmonitor.search.toolbar.clear"),
      onClick: () => {
  ...
  renderCaseSensitiveButton() {
    ...
    return button({
      ...
      title: L10N.getString("netmonitor.search.toolbar.caseSensitive"),
  ...
  renderFilterBox() {
    ...
    return SearchBox({
      ...
      placeholder: L10N.getString("netmonitor.search.toolbar.inputPlaceholder"),
      type: "search",
