...
var HarMenuUtils = {
  ...
  openHarFile(actions, openSplitConsole) {
    ...
    fp.init(
      window,
      L10N.getString("netmonitor.har.importHarDialogTitle"),
      Ci.nsIFilePicker.modeOpen
    );

    // Append file filters
    fp.appendFilter(
      L10N.getString("netmonitor.har.importDialogHARFilter"),
      "*.har"
    );
    fp.appendFilter(L10N.getString("netmonitor.har.importDialogAllFilter"), "*.*");
