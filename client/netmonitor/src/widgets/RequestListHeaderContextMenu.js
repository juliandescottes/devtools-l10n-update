  ...
  open(event = {}, columns) {
    ...
    for (const column in columns) {
      ...
      const label = nonLocalizedHeaders.includes(column)
        ...
        : L10N.getString(`netmonitor.toolbar.${stringMap[column] || column}`);
      const entry = {
    ...
    menu.push({
      label: L10N.getString("netmonitor.toolbar.timings"),
      submenu: subMenu.timings,
    });
    menu.push({
      label: L10N.getString("netmonitor.toolbar.responseHeaders"),
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.toolbar.resetColumns"),
      click: () => this.props.resetColumns(),
    });

    menu.push({
      id: "request-list-header-reset-sorting",
      label: L10N.getString("netmonitor.toolbar.resetSorting"),
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.toolbar.resizeColumnToFitContent"),
