...
class RequestListContextMenu {
  ...
  createCopySubMenu(clickedRequest, requests) {
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyUrl"),
      accesskey: L10N.getString("netmonitor.context.copyUrl.accesskey"),
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyUrlParams"),
      accesskey: L10N.getString("netmonitor.context.copyUrlParams.accesskey"),
    ...
    copySubMenu.push({
      ...
      label: L10N.getFormatString("netmonitor.context.copyRequestData", method),
      accesskey: L10N.getString("netmonitor.context.copyRequestData.accesskey"),
    ...
    if (OS === "WINNT") {
      copySubMenu.push({
        ...
        label: L10N.getFormatString(
          ...
          L10N.getString("netmonitor.context.copyAsCurl")
        ),
        accesskey: L10N.getString("netmonitor.context.copyAsCurl.win.accesskey"),
        // Menu item will be visible even if data hasn't arrived, so we need to check
        // *Available property and then fetch data lazily once user triggers the action.
        visible: !!clickedRequest,
        click: () =>
      ...
      copySubMenu.push({
        ...
        accesskey: L10N.getString("netmonitor.context.copyAsCurl.posix.accesskey"),
        // Menu item will be visible even if data hasn't arrived, so we need to check
        // *Available property and then fetch data lazily once user triggers the action.
        visible: !!clickedRequest,
        click: () =>
      ...
      copySubMenu.push({
        ...
        label: L10N.getString("netmonitor.context.copyAsCurl"),
        accesskey: L10N.getString("netmonitor.context.copyAsCurl.accesskey"),
        // Menu item will be visible even if data hasn't arrived, so we need to check
        // *Available property and then fetch data lazily once user triggers the action.
        visible: !!clickedRequest,
        click: () =>
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyAsFetch"),
      accesskey: L10N.getString("netmonitor.context.copyAsFetch.accesskey"),
      visible: !!clickedRequest,
      click: () =>
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyRequestHeaders"),
      accesskey: L10N.getString("netmonitor.context.copyRequestHeaders.accesskey"),
      // Menu item will be visible even if data hasn't arrived, so we need to check
      // *Available property and then fetch data lazily once user triggers the action.
      visible: !!(
        clickedRequest &&
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyResponseHeaders"),
      accesskey: L10N.getString(
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyResponse"),
      accesskey: L10N.getString("netmonitor.context.copyResponse.accesskey"),
      // Menu item will be visible even if data hasn't arrived, so we need to check
      // *Available property and then fetch data lazily once user triggers the action.
      visible: !!(
        clickedRequest &&
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyImageAsDataUri"),
      accesskey: L10N.getString("netmonitor.context.copyImageAsDataUri.accesskey"),
      visible: !!(
        clickedRequest &&
        (responseContentAvailable || responseContent) &&
        mimeType &&
    ...
    copySubMenu.push({
      ...
      label: L10N.getString("netmonitor.context.copyAllAsHar"),
      accesskey: L10N.getString("netmonitor.context.copyAllAsHar.accesskey"),
  ...
  createMenu(clickedRequest, requests, blockedUrls) {
    ...
    menu.push({
      label: L10N.getString("netmonitor.context.copy"),
      accesskey: L10N.getString("netmonitor.context.copy.accesskey"),
      visible: !!clickedRequest,
      submenu: copySubMenu,
    });
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.saveAllAsHar"),
      accesskey: L10N.getString("netmonitor.context.saveAllAsHar.accesskey"),
      visible: requests.length > 0,
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.saveImageAs"),
      accesskey: L10N.getString("netmonitor.context.saveImageAs.accesskey"),
      visible: !!(
        clickedRequest &&
        (responseContentAvailable || responseContent) &&
        mimeType &&
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.resend.label"),
      accesskey: L10N.getString("netmonitor.context.resend.accesskey"),
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.editAndResend"),
      accesskey: L10N.getString("netmonitor.context.editAndResend.accesskey"),
      visible: !!(clickedRequest && !isCustom),
      click: () => {
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.blockURL"),
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.unblockURL"),
      visible: hasMatchingBlockingRequestPattern(
        blockedUrls,
        clickedRequest.url
      ),
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.newTab"),
      accesskey: L10N.getString("netmonitor.context.newTab.accesskey"),
      visible: !!clickedRequest,
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.openInDebugger"),
      accesskey: L10N.getString("netmonitor.context.openInDebugger.accesskey"),
      visible: !!(
        clickedRequest &&
        mimeType &&
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.openInStyleEditor"),
      accesskey: L10N.getString("netmonitor.context.openInStyleEditor.accesskey"),
      visible: !!(
        clickedRequest &&
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.perfTools"),
      accesskey: L10N.getString("netmonitor.context.perfTools.accesskey"),
      visible: requests.length > 0,
    ...
    menu.push({
      ...
      label: L10N.getString("netmonitor.context.useAsFetch"),
      accesskey: L10N.getString("netmonitor.context.useAsFetch.accesskey"),
      visible: !!clickedRequest,
      click: () =>
