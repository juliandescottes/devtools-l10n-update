...
add_task(async function() {
  ...
  function testL10N() {
    is(
      typeof L10N.getString("netmonitor.security.enabled"),
      "string",
      "The getString() method didn't return a valid string."
    );
    is(
      typeof L10N.getFormatString("networkMenu.totalMS2", "foo"),
      "string",
      "The getFormatString() method didn't return a valid string."
    );
  }
