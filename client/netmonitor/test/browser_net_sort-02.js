    ...
    for (const header of headers) {
      if (header != target) {
        ...
        ok(
          !header
            .getAttribute("title")
            .includes(L10N.getString("networkMenu.sortedAsc")) &&
            !header
              .getAttribute("title")
              .includes(L10N.getString("networkMenu.sortedDesc")),
          "The " +
            header.id +
        ...
        const sorted =
          direction == "ascending"
            ? L10N.getString("networkMenu.sortedAsc")
            : L10N.getString("networkMenu.sortedDesc");
        ok(
