...
function createContextMenu(event, message, webConsoleWrapper) {
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.copyURL.label"),
      accesskey: l10n.getString("webconsole.menu.copyURL.accesskey"),
  ...
  if (toolbox && request) {
    ...
    menu.append(
      new MenuItem({
        ...
        label: l10n.getString("webconsole.menu.openInNetworkPanel.label"),
        accesskey: l10n.getString("webconsole.menu.openInNetworkPanel.accesskey"),
        visible: source === MESSAGE_SOURCE.NETWORK,
    ...
    menu.append(
      new MenuItem({
        ...
        label: l10n.getString("webconsole.menu.resendNetworkRequest.label"),
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.openURL.label"),
      accesskey: l10n.getString("webconsole.menu.openURL.accesskey"),
      visible: source === MESSAGE_SOURCE.NETWORK,
      click: () => {
        if (!request) {
          return;
  ...
  if (isConnectedElement && contentDomReferenceEl) {
    ...
    menu.append(
      new MenuItem({
        ...
        label: l10n.getString("webconsole.menu.openNodeInInspector.label"),
        accesskey: l10n.getString("webconsole.menu.openNodeInInspector.accesskey"),
        disabled: false,
        click: () =>
          dispatch(
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.storeAsGlobalVar.label"),
      accesskey: l10n.getString("webconsole.menu.storeAsGlobalVar.accesskey"),
      disabled: !actor,
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.copyMessage.label"),
      accesskey: l10n.getString("webconsole.menu.copyMessage.accesskey"),
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.copyObject.label"),
      accesskey: l10n.getString("webconsole.menu.copyObject.accesskey"),
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.selectAll.label"),
      accesskey: l10n.getString("webconsole.menu.selectAll.accesskey"),
      disabled: false,
      click: () => {
  ...
  exportSubmenu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.exportSubmenu.exportCliboard.label"),
      disabled: false,
      click: () => {
        const webconsoleOutput = parentNode.querySelector(".webconsole-output");
  ...
  exportSubmenu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.exportSubmenu.exportFile.label"),
      disabled: false,
  ...
  menu.append(
    new MenuItem({
      ...
      label: l10n.getString("webconsole.menu.exportSubmenu.label"),
      disabled: false,
  ...
  if (shouldOpenSidebar) {
    menu.append(
      new MenuItem({
        ...
        label: l10n.getString("webconsole.menu.openInSidebar.label1"),
        accesskey: l10n.getString("webconsole.menu.openInSidebar.accesskey"),
