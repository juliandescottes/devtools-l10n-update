...
add_task(async function() {
  ...
  if (Services.appinfo.OS === "Darwin") {
    clearShortcut = WCUL10n.getString("webconsole.clear.keyOSX");
  } else {
    clearShortcut = WCUL10n.getString("webconsole.clear.key");
  }
  ...
  if (Services.appinfo.OS === "Darwin") {
    ...
    synthesizeKeyShortcut(WCUL10n.getString("webconsole.clear.alternativeKeyOSX"));
  ...
  synthesizeKeyShortcut(WCUL10n.getString("webconsole.find.key"));
