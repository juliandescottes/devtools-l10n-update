...
class ReverseSearchInput extends Component {
  ...
  renderSearchInformation() {
    ...
    if (reverseSearchTotalResults === 0) {
      text = l10n.getString("webconsole.reverseSearch.noResult");
    } else {
      const resultsString = l10n.getString("webconsole.reverseSearch.results");
  ...
  render() {
    ...
    return dom.div(
      ...
      dom.input({
        ...
        autoFocus: true,
        placeholder: l10n.getString("webconsole.reverseSearch.input.placeHolder"),
