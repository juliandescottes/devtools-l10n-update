...
const disabledCssFilterButtonTitle = l10n.getString(
...
class FilterBar extends Component {
  ...
  renderClearButton() {
    return dom.button({
      ...
      title: l10n.getString("webconsole.clearButton.tooltip"),
  ...
  renderFiltersConfigBar() {
    ...
    return dom.div(
      ...
      FilterButton({
        ...
        label: getLabel(
          l10n.getString("webconsole.errorsFilterButton.label"),
          FILTERS.ERROR
        ),
      ...
      FilterButton({
        ...
        label: getLabel(
          l10n.getString("webconsole.warningsFilterButton.label"),
          FILTERS.WARN
        ),
      ...
      FilterButton({
        ...
        label: getLabel(
          l10n.getString("webconsole.logsFilterButton.label"),
          FILTERS.LOG
        ),
      ...
      FilterButton({
        ...
        label: getLabel(
          l10n.getString("webconsole.infoFilterButton.label"),
          FILTERS.INFO
        ),
      ...
      FilterButton({
        ...
        label: getLabel(
          l10n.getString("webconsole.debugFilterButton.label"),
          FILTERS.DEBUG
        ),
      ...
      FilterButton({
        ...
        label: l10n.getString("webconsole.cssFilterButton.label"),
        filterKey: FILTERS.CSS,
        dispatch,
      }),
      FilterButton({
        active: filter[FILTERS.NETXHR],
        label: l10n.getString("webconsole.xhrFilterButton.label"),
        filterKey: FILTERS.NETXHR,
        dispatch,
      }),
      FilterButton({
        active: filter[FILTERS.NET],
        label: l10n.getString("webconsole.requestsFilterButton.label"),
  ...
  renderSearchBox() {
    ...
    if (filteredMessagesCount.text > 0) {
      searchBoxSummary = l10n.getString("webconsole.filteredMessagesByText.label");
      searchBoxSummary = PluralForm.get(
        filteredMessagesCount.text,
        searchBoxSummary
      ).replace("#1", filteredMessagesCount.text);

      searchBoxSummaryTooltip = l10n.getString(
    ...
    return SearchBox({
      type: "filter",
      placeholder: l10n.getString("webconsole.filterInput.placeholder"),
      keyShortcut: l10n.getString("webconsole.find.key"),
  ...
  renderCloseButton() {
    ...
    return dom.div(
      ...
      dom.button({
        ...
        title: l10n.getString("webconsole.closeSplitConsoleButton.tooltip"),
        onClick: () => {
          closeSplitConsole();
        },
      })
