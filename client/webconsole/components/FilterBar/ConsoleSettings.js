    ...
    if (!hideShowContentMessagesCheckbox) {
      items.push(
        MenuItem({
          ...
          label: l10n.getString("browserconsole.contentMessagesCheckbox.label"),
          tooltip: l10n.getString(
    ...
    return MenuButton(
      {
        ...
        title: l10n.getString("webconsole.console.settings.menu.button.tooltip"),
      },
