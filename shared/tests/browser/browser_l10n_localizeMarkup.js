...
add_task(async function() {
  ...
  const str1 = STARTUP_L10N.getString("inspector.label");
  const str2 = STARTUP_L10N.getString("inspector.accesskey");
  const str3 = TOOLBOX_L10N.getString("toolbox.defaultTitle");
  ok(
    str1 && str2 && str3,
